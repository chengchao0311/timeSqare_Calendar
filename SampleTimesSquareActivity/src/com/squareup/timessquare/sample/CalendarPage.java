...
public class CalendarPage extends FragmentActivity implements
	...
	public static SharedPreferences appConfig;//配置文件
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		startTime.set(Calendar.YEAR,appConfig.getInt("calendar_start_year", 1995));//
		startTime.set(Calendar.MONTH,appConfig.getInt("calendar_start_month", 0));//
		startTime.set(Calendar.DAY_OF_MONTH,appConfig.getInt("calendar_start_date", 1));//
		Date startDate = startTime.getTime();
		PNCalendar pnCalendar = null;
		try { pnCalendar = PNCalendar.findPNCalendarByDisplayName(this,
		...
		addEventBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				CalendarPage.this.startActivityForResult(intent,
						appConfig.getInt("calendarpage_eventdetail", 1110));
			}
		});
